...
import type { NotesRepository, PollsRepository, NoteReactionsRepository, UsersRepository, FollowRequestsRepository, FollowRequest } from '@/models/index.js';
		...
		switch (parsed.type) {
			...
			case 'follows':
				return this.followRequestsRepository.findOneBy({ id: parsed.id })
					.then(async (followRequest: FollowRequest) => {
						...
						return this.apRendererService.addContext(this.apRendererService.renderFollow(follower as LocalUser | RemoteUser, followee as LocalUser | RemoteUser, url));
					});
